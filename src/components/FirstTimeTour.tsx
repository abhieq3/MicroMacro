...
function buildSteps(role: string): Step[] {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      body: isLead
        ? "Your whole scope at a glance — project health, who's loaded, what's overdue, and the Bird's-eye button for the full tree."
        : "Your work at a glance — what's due, what's coming up, and the projects you're part of.",
