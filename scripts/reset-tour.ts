 ...
 * `pragati-tour-v6` localStorage key for that account — the component checks
...
async function main() {
  ...
  console.log("Also clear localStorage key 'pragati-tour-v6' in that browser before recording.");
