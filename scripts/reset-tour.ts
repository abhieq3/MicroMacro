 ...
 * `pragati-tour-v7` localStorage key for that account — the component checks
...
async function main() {
  ...
  console.log("Also clear localStorage key 'pragati-tour-v7' in that browser before recording.");
